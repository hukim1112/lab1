...
gan_data.mutual_penalty_weight = 3
gan_data.learning_rate = 10**2
gan_model = infogan.Info_gan(gan_data)
result_dir = os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '101', 'result')
ckpt_dir =  os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '101', 'weight')
log_dir =  os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '101', 'weight')
if not os.path.isdir(result_dir):
		os.makedirs(result_dir)
if not os.path.isdir(ckpt_dir):
		os.makedirs(ckpt_dir)
...
gan_data = data.Data(cat_dim, code_con_dim, 20, channel, path, name, split_name, batch_size)
gan_data.mutual_penalty_weight = 3
gan_data.learning_rate = 10**2
gan_model = infogan.Info_gan(gan_data)
result_dir = os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '102', 'result')
ckpt_dir =  os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '102', 'weight')
log_dir =  os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '102', 'weight')
if not os.path.isdir(result_dir):
		os.makedirs(result_dir)
if not os.path.isdir(ckpt_dir):
		os.makedirs(ckpt_dir)
...
gan_data.learning_rate = 10**2
gan_model = infogan.Info_gan(gan_data)
result_dir = os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '103', 'result')
ckpt_dir =  os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '103', 'weight')
log_dir =  os.path.join('/media/dan/DATA/hukim/Research/srnet/infogan_exp', '103', 'weight')
if not os.path.isdir(result_dir):
		os.makedirs(result_dir)
if not os.path.isdir(ckpt_dir):
		os.makedirs(ckpt_dir)
...
gan_model = infogan.Info_gan(gan_data)
gan_model.train(result_dir, ckpt_dir, log_dir, training_iteration = 150005, G_update_num=5, D_update_num=1, Q_update_num=2)
del gan_data
del gan_model
